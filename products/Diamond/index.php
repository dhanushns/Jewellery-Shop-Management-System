...
<title>NS - Diamond product</title>
</head>
...
<body>
  ...
  <div class="container1">
    ...
    <div class="products chain">
      ...
      $sql_cmd = "SELECT COUNT(category) from products WHERE category = 'DC'";
      $result = $conn->query($sql_cmd);
      $row = mysqli_fetch_array($result);
      $count = $row[0];
      $sql_cmd = "SELECT * FROM products WHERE category = 'DC'";
      $result = $conn->query("$sql_cmd");
      $session_login = 0;
        ...
        for ($i = 1; $i <= $count; $i++) {
          ...
          echo "<div class='group'>
              ...
              <button style='border:none;background-color:transparent;' data-bs-toggle='modal' data-bs-target='#modal_$id'>
                <img src='diamond chain/dc-$i.jpeg'>
              </button>
  ...
  <div class="container1">
    ...
    <div class="products earings">
      <?php
      $sql_cmd = "SELECT COUNT(category) from products WHERE category = 'DE'";
      $result = $conn->query($sql_cmd);
      $row = mysqli_fetch_array($result);
      $count = $row[0];
      $sql_cmd = "SELECT * FROM products WHERE category = 'DE'";
      $result = $conn->query("$sql_cmd");
      $session_login = 0;
     ...
     for ($i = 1; $i <= $count; $i++) {
      ...
      echo "<div class='group'>
          ...
          <button style='border:none;background-color:transparent;' data-bs-toggle='modal' data-bs-target='#modal_$id'>
            <img src='diamond earrings/de-$i.jpeg'>
          </button>
          <div class='text-wrapper price'>$name  </div>
          <div class='text-wrapper price'>&#8377 $price</div>
        </div>";
  ...
  <div class="container1">
    ...
    <div class="products rings">
      <?php
      $sql_cmd = "SELECT COUNT(category) from products WHERE category = 'DR'";
      $result = $conn->query($sql_cmd);
      $row = mysqli_fetch_array($result);
      $count = $row[0];
      $sql_cmd = "SELECT * FROM products WHERE category = 'DR'";
      $result = $conn->query("$sql_cmd");
      $session_login = 0;
      ...
      if(isset($_SESSION['username'])){
       ...
       for ($i = 1; $i <= $count; $i++) {
        ...
        echo "<div class='group'>
            ...
            <button style='border:none;background-color:transparent;' data-bs-toggle='modal' data-bs-target='#modal_$id'>
              <img src='diamond rings/dr-$i.jpeg'>
            </button>
            <div class='text-wrapper price'>$name  </div>
            <div class='text-wrapper price'>&#8377 $price</div>
          </div>";
