...
<div class="container1" id='chains'>
  ...
  <div class="products chain">
    <?php
      set_error_handler('gold_session_notice_handler');

      function gold_session_notice_handler($severity, $message, $filename, $lineno) {
      ...
      $sql_cmd = "SELECT COUNT(category) from products WHERE category = 'Gold Chain'";
      $result = $conn->query($sql_cmd);
      $row = mysqli_fetch_array($result);
      $count = $row[0];
      $sql_cmd = "SELECT * FROM products WHERE category = 'Gold Chain'";
      $result = $conn->query("$sql_cmd");
      $session_login = 0;
        ...
        for ($i = 1; $i <= $count; $i++) {
          ...
          echo "<div class='group'>
              ...
              <button style='border:none;background-color:transparent;' data-bs-toggle='modal' data-bs-target='#modal_$id'>
                <img src='Gold/Chain/GC00$i.jpeg'>
              </button>
...
<div class="container1" id='earrings'>
  ...
  <div class="products earings">
    <?php
      $sql_cmd = "SELECT COUNT(category) from products WHERE category = 'Gold Earring Jumka'";
      $result = $conn->query($sql_cmd);
      $row = mysqli_fetch_array($result);
      $count = $row[0];
      $sql_cmd = "SELECT * FROM products WHERE category = 'Gold Earring Jumka'";
      $result = $conn->query("$sql_cmd");
      $session_login = 0;
     ...
     for ($i = 1; $i <= $count; $i++) {
      ...
      echo "<div class='group'>
          ...
          <button style='border:none;background-color:transparent;' data-bs-toggle='modal' data-bs-target='#modal_$id'>
            <img src='Gold/Earring/Jumka/GEJ00$i.jpeg'>
          </button>
          <div class='text-wrapper price'>$name  </div>
          <div class='text-wrapper price'>&#8377 $price</div>
        </div>";
  ...
  <div class="products earings">
    <?php
      $sql_cmd = "SELECT COUNT(category) from products WHERE category = 'Gold Earring Antique'";
      $result = $conn->query($sql_cmd);
      $row = mysqli_fetch_array($result);
      $count = $row[0];
      $sql_cmd = "SELECT * FROM products WHERE category = 'Gold Earring Antique'";
      $result = $conn->query("$sql_cmd");
      $session_login = 0;
     ...
     for ($i = 1; $i <= $count; $i++) {
      ...
      echo "<div class='group'>
          ...
          <button style='border:none;background-color:transparent;' data-bs-toggle='modal' data-bs-target='#modal_$id'>
            <img src='Gold/Earring/Antique/GEA00$i.jpeg'>
          </button>
          <div class='text-wrapper price'>$name  </div>
          <div class='text-wrapper price'>&#8377 $price</div>
        </div>";
  ...
  <div class="products earings">
    <?php
      $sql_cmd = "SELECT COUNT(category) from products WHERE category = 'Gold Earring Elegant'";
      $result = $conn->query($sql_cmd);
      $row = mysqli_fetch_array($result);
      $count = $row[0];
      $sql_cmd = "SELECT * FROM products WHERE category = 'Gold Earring Elegant'";
      $result = $conn->query("$sql_cmd");
      $session_login = 0;
     ...
     for ($i = 1; $i <= $count; $i++) {
      ...
      echo "<div class='group'>
          ...
          <button style='border:none;background-color:transparent;' data-bs-toggle='modal' data-bs-target='#modal_$id'>
            <img src='Gold/Earring/Elegant/GEE00$i.jpeg'>
          </button>
          <div class='text-wrapper price'>$name  </div>
          <div class='text-wrapper price'>&#8377 $price</div>
        </div>";
...
<div class="container1" id='rings'>
  ...
  <div class="products rings">
    <?php
      $sql_cmd = "SELECT COUNT(category) from products WHERE category = 'Gold Ring'";
      $result = $conn->query($sql_cmd);
      $row = mysqli_fetch_array($result);
      $count = $row[0];
      $sql_cmd = "SELECT * FROM products WHERE category = 'Gold Ring'";
      $result = $conn->query("$sql_cmd");
      $session_login = 0;
