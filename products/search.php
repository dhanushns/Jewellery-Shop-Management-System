...
<body>
  ...
  if(isset($_POST['search'])){
    $key = $_POST['search'];
    echo "<script>search('$key')</script>";
    echo "<div class='searchResult' id='result'>
    <div class='result-header'>
      <h1><span>Your search results for :<span> $key<h1>
    </div>
  </div>
  <div class = 'no-data' id = 'no-data'>
    <img src ='./banners/no.jpeg'>
    <h3><span>$key not found</span></h3>
  </div>";
  }
  ?>
